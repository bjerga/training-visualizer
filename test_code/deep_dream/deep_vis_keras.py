...
def create_initial_image(model_input_shape):
    ...
    # return a random, intial image, and the color axis of the image
...
def ensemble_regularization(input_img_data, grads_value, iteration, color_axis):
    ...
    if contribution_percentile > 0:
        ...
        high_abs_contribution_mask = contribution >= np.percentile(contribution, contribution_percentile)
...
def main():
    ...
    save_visualization(model.input_shape, kept_images)
